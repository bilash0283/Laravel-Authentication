        ...
        <div class="w-full my-6">
            <form action="{{ route('category_update',[$categories->id]) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="max-w-sm my-2">
                  ...
                  <input type="text" name="name" value="{{ $categories->name }}" id="input-label" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Enter Name">  
              </div>
              <div class="max-w-sm my-2">
              ...
              <div class="max-w-sm my-2">
                  ...
                  <img src="{{ asset($categories->image) }}" class="w-10 h-10" alt="Category Image">
              </div>
              <div class="max-w-sm my-2">
                  ...
                  <select name="status" class="py-3 px-4 pe-9 block w-full bg-white border-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:border-transparent dark:text-neutral-400 ">
                      ...
                      <option value="2" {{ $categories->status == 2 ? "selected" : "" }}>Inactive</option>
                  </select>
              </div>
              <div class="max-w-sm my-2">
